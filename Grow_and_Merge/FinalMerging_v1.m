function [segments,score,Hist,HistDiff,area,Edge,DTex,meanCC,meanLGTex,adj,Rnum]=FinalMerging_v1(segments,score,Hist,HistDiff,area,Edge,DTex,LabIm,meanCC,textureImg,meanLGTex,adj,LongContour25,LongContour80,edge_map,Rnum,Nseg)
    W=200;
    ...
    for order=1:length(Loc)  
        ...
        if  contact_rate >=0.05 && Edge(L1,L2).Rate80<=0.6 
