function [segments,score,Hist,HistDiff,area,Edge,DTex,meanCC,meanLGTex,meanSaliency,adj,Rnum]=FinalMerging_v6(segments,score,Hist,HistDiff,area,Edge,DTex,LabIm,meanCC,textureImg,meanLGTex,SaliencyMap,meanSaliency,adj,LongContourMap25,LongContourMap80,edge_map,Rnum,Nseg)
    if  Rnum>=15
        SVTh=0.42; 
    elseif Rnum>12 && Rnum<15
        SVTh=0.5;
    else % Rnum<=12
        SVTh=0.6; 
    end
