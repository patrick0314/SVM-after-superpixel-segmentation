function [segments,score,Hist,HistDiff,area,Edge,DTex,meanCC,meanLGTex,adj,Rnum]=FinalMerging_v2(segments,score,Hist,HistDiff,area,Edge,DTex,LabIm,meanCC,textureImg,meanLGTex,adj,LongContourMap25,LongContourMap80,LongContourMap30,edge_map,Rnum,Nseg)
    W=400;
    ...
    for order=1:length(Loc)  
        ...
        if  contact_rate>=0.05 && EdgeRate30<=0.6
